			...
			<div class="box-body">
				<form role="form" id="" method="post" action="">
					<fieldset class="custom-fieldset">
						<legend class="custom-legend">주문하시는 분</legend>
						...
						<div class="form-group row">
							...
							<div class="col-10">
								<input type="text" class="form-control" name="mbsp_addr"
									id="sample2_address" placeholder="기본주소입력...">
							</div>
						</div>
						<div class="form-group row">
							<label for="sample2_detailAddress" class="col-2">상세주소</label>
							<div class="col-10">
								<input type="text" class="form-control" name="mbsp_deaddr"
									id="sample2_detailAddress" placeholder="상세주소입력..."> <input
					...
					<fieldset class="custom-fieldset">
						<legend class="custom-legend">결제방법 선택</legend>
						<div class="form-group row">
						...
						<div class="form-group row" id="nobank_info" style="display: none;">
							...
							<div class="col-10">
								...
								<select name="pay_nobank" id="pay_nobank">
									<option value="123-123-1234">신한은행</option>
									<option value="456-456-4567">국민은행</option>
									<option value="100-100-1000">NH농협</option>
									<option value="200-200-2000">우리은행</option>
								</select><br> 
