					...
					<div class="box-body">
						...
						<table class="table table-bordered">
							...
							<tr>
								...
								<td><button type="button" class="btn btn-danger btn_pro_mem_del">삭제</button></td>
							</tr>
							</c:forEach>
							</tbody></table>
					</div>
...
<script>
  $(document).ready(function() {
    ...
    $(".movepage").on("click", function(e) {
      ...
      actionForm.attr("action", "/admin/product/pro_member_list");
  ...
  $(".btn_pro_mem_del").on("click", function() {
